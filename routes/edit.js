...
router.post('/edit/:title', function(req,res) {
  ...
  form.parse(req, function(err, fields, files) {
     if(files.imagePath.name=='' && files.upload==undefined){
      connection.query('UPDATE `portfolio` SET `description`=?,`long_description`=?, `title`=? WHERE `title`=?',
      ...
      connection.query('UPDATE `portfolio` SET `description`=?,`long_description`=?, `showcase_image`=?, `title`=? WHERE `title`=?',
      [fields.description , fields.longDescription , images, fields.title , title])
    }
    else if(files.upload==undefined){
      connection.query('UPDATE `portfolio` SET `description`=?,`long_description`=?, `image_path`=?, `title`=? WHERE `title`=?',
      ...
      connection.query('UPDATE `portfolio` SET `description`=?,`long_description`=?, `image_path`=?, `showcase_image`=?,`title`=? WHERE `title`=?',
